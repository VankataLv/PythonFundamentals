...
middle_of_list = (len(seq_num) // 2) + 1        # The len of the list will always be odd

for current_time_left in seq_num[0:middle_of_list - 1]:   # middle - 1, because middle is the 0 that separates left/right
